...
import { SpeakerLoudIcon, Cross1Icon, TriangleRightIcon } from '@radix-ui/react-icons';
...
const AudioRecordComponent: React.FC<audioRecordComponentProps>  = ({title, recording1, setRecording1, audioUrl1, setAudioUrl1, playing1, setPlaying1, startRecording, stopRecording, id }: audioRecordComponentProps,) => {
  return (
